...
#ifndef MYVTKORIENTATIONMARKERWIDGET_H_
#define MYVTKORIENTATIONMARKERWIDGET_H_
...
class vtkPolyData;
class vtkProp;
class MyVtkOrientationMarkerWidgetObserver;
class vtkRenderer;

using ClickAxisTipFunc= std::function<void(bool &bX, bool &bY, bool &bZ)>;

class  MyvtkOrientationMarkerWidget : public vtkInteractorObserver
{
public:
  static MyvtkOrientationMarkerWidget* New();
  vtkTypeMacro(MyvtkOrientationMarkerWidget, vtkInteractorObserver);
...
protected:
  ...
  ~MyvtkOrientationMarkerWidget() override;
  ...
  MyVtkOrientationMarkerWidgetObserver *Observer;
...
private:
    MyvtkOrientationMarkerWidget(const MyvtkOrientationMarkerWidget&) = delete;
  void operator=(const MyvtkOrientationMarkerWidget&) = delete;
  ...
  //是否点击某个轴的箭头
  bool IsClickXAxisTip(int ix, int iy);
  bool IsClickYAxisTip(int ix, int iy);
  bool IsClickZAxisTip(int ix, int iy);

  public :
      vtkActor          *m_XAxisTip;
      vtkActor          *m_YAxisTip;
      vtkActor          *m_ZAxisTip;
      ClickAxisTipFunc m_pClickTipFunc = nullptr;
